    ...
    <div className="trade-tabs-right">
      <div className={classes.root}>
        <AppBar position="static" color="default">
          ...
          {/* <ul class="Trade-tabs">
            <li className="active"><span>1</span> Choose Role </li>
            <li><span>2</span> Bank Account</li>
            <li><span>3</span> Demat Account</li>
            <li><span>4</span> NSDL Active Account</li>
            <li><span>5</span> PAN KYC Verification</li>
            <li><span>6</span> Aadhar Linked</li>
          </ul> */}
        </AppBar>
        <SwipeableViews
