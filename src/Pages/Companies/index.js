          ...
          <div className="row">
            <div className="col-md-2 pr-1">
              <div className="sun bg-white">
                <div className="moon">
                  <h4>Filter<span className="pull-right float-right"><Link to="#">Clear All</Link></span></h4>
                </div>
                <div className="earth">
                  ...
                  {SectorList && SectorList.map((item, index) => {
                      return <div className="form-group " key={index}>
                        <p className="d-flex align-items-center">  <input type="checkbox" name="sector_value" value={item.value} onChange={this.sectorChange}/> <span>{item.label}</span></p>
                      </div>;
                    })}
                  ...
                  {SeriesOfFundingList && SeriesOfFundingList.map((item, index) => {
                      return <div className="form-group" key={index}>
                        <p className="d-flex align-items-center">  <input type="checkbox" name="company_series_of_funding" value={item.value} onChange={this.fundingChange}/> <span>{item.label}</span></p>
                      </div>;
                    })}
                  </div>
